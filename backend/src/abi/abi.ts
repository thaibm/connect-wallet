export const USDC_ABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'spender', type: 'address', internalType: 'address' },
      { name: 'decrement', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [{ name: '', type: 'bool', internalType: 'bool' }],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'tokenCurrency', type: 'string', internalType: 'string' },
      { name: 'tokenDecimals', type: 'uint8', internalType: 'uint8' },
      { name: 'newMasterMinter', type: 'address', internalType: 'address' },
      { name: 'newPauser', type: 'address', internalType: 'address' },
      { name: 'newBlacklister', type: 'address', internalType: 'address' },
  ...
  },
  {
    ...
    name: 'initializeV2_1',
    inputs: [
      { name: 'lostAndFound', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: '_newBlacklister', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    name: 'updatePauser',
    inputs: [
      { name: '_newPauser', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'updateRescuer',
    inputs: [
      { name: 'newRescuer', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
...
export const MASTER_MINTER_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
